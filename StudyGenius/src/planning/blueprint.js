...
const { buildVisualCoverageMatrix, enrichCoverageFromEvidence } = require('../core/visualCoverage');
 ...
 * @returns {Object}
 */
function buildBlueprintFromGraphAndPlan(sessionId, subject, knowledgeGraph, masterPlanText = '', options = {}) {
  ...
  // Arricchimento semantico con evidenze multimodali estratte (v2.0)
  if (visualContracts.length > 0) {
    blueprint.visualCoverageMatrix = enrichCoverageFromEvidence(blueprint.visualCoverageMatrix, visualContracts);
  }
