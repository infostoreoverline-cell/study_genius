...
1. **Titoli dei Capitoli e Mappa Concettuale**: Prerequisiti necessari, concetti cardine e progressione logica (Intuizione → Definizione → Formalizzazione → Derivazioni → Casi limite).
...
`;
      ...
      let moduleText = '';
      const maxTokensPerCall = isSummaryMode ? 4200 : 8000;
      try {
