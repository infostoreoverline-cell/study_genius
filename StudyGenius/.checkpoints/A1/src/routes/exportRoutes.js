...
router.post('/export-pdf', async (req, res) => {
  try {
    const { html, markdown, title, subject, knowledgeGraph } = req.body;
    console.log('📥 [/api/export-pdf] Richiesta ricevuta:', { hasMarkdown: !!markdown, hasHtml: !!html, title, subject, hasKg: !!knowledgeGraph });
